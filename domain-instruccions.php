...
<article class="content">
  ...
  <section class="section">
    <div class="row">
      <?php
      echo '<h5>';
      printf(_("Añadir dominios al sistema te permite activar varios servicios. Puedes activar cualquier dominio desde la página <a href='add-domain.php'><button type='button' class='btn btn-primary'>Añadir dominios</button></a>"));
      echo '</h5><p>';
      ...
      echo '</h6>'; 
        echo '<p>';
          printf (_("Para que una página web esté disponible visitando tu dominio desde un navegador, es neceario que el valor del registro A de los DNS del dominio sea el mismo que la IP de este servidor."));
        echo '</p>';
          ...
          echo '<p>';
            ...
            printf (_("Este registro es estrictamente indispensable. Para que el correo electrónico sea gestionado por tu servidor y no por otro servicio externo, el valor del registro MX de los DNS de tu domminio o subdominio tendrá que ser el mismo que el el nombre de ese equipo: %s . Algunos proveedores de dominio pueden necesitar que añadas un punto después del valor."), $fqdn);
...
printf(_("<h6>Ejemplos de registros MX para dominio example.com y subdominio sub.example.com</h6>"));
 ...
 printf(_("<h6>Ejemplos de registros MX  para dominio example.com y subdominio sub.example.com en texto (para aquellos proveedores que no proporcionan formulario)</h6>"));
          ...
          echo '</h6>';
          echo '<p>';
            printf(_("El objetivo de DKIM es asegurar que un mensaje enviado por example.com sea realmente de example.com. Para ello, DKIM agrega automáticamente una firma digital a cada mensaje. Esta firma se basa en una clave privada conocida únicamente por el servidor que envía el correo. El servidor que lo recibe puede utilizar la clave pública (incluida en el registro DKIM de los DNS) para decodificar la firma y asegurarse de que el mensaje no ha sido alterado. Aunque el propósito inicial era la seguridad, muchos ISP, incluyendo Gmail, Yahoo y otros, usan la información de DKIM para validar la calidad y la autenticidad del mensaje. Si la firma DKIM falla, existe una probabilidad muy alta de que el mensaje sea enviado a la carpeta de spam.<br />
Vista la complejidad de su configuración, es mejor asegurarse de que se ha insertado correctamente su valor en los DNS ya que, al igual que pasa los registros SPF, es mejor no tener ningún registro DKIM que tener uno incorrecto.<br />
...
printf(_("<h6>Ejemplos de registros DKIM para dominio example.com (Nota la presencia o no de las comillas en el campo 'Value'. En algunos casos son necesarias, mientras que en otros no)</h6>"));
...
printf(_("<h6>Ejemplos de registros DKIM para subdominio sub.example.com (Nota la presencia o no de las comillas en el campo 'Value'. En algunos casos son necesarias, mientras que en otros no)"));
